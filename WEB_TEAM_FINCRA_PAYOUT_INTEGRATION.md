...
## Mobile App Changes (pending web team completion)

The following mobile changes are ready but **not yet pushed to OTA** — will be deployed once the web team confirms Fincra is live on the backend:
