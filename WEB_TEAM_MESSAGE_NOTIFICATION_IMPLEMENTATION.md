...
## Status: REQUIRED - Users don't receive notifications when messages are sent
...
| Backend: Message notification trigger | ❌ **NOT IMPLEMENTED** |
...
Ensure the `notification_preferences` table has the message column:
