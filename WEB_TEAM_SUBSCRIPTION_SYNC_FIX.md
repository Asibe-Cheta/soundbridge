...
**File:** [database/ADD_MISSING_PROFILES_COLUMNS.sql](database/ADD_MISSING_PROFILES_COLUMNS.sql) ✅ **CREATED**
...
# Copy and paste the contents of database/ADD_MISSING_PROFILES_COLUMNS.sql
# OR use psql:
psql -d your_database -f database/ADD_MISSING_PROFILES_COLUMNS.sql
```
...
**File:** [database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql](database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql) ✅ **CREATED**
...
```bash
# In Supabase SQL Editor
# Copy and paste the contents of database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql
# OR use psql:
psql -d your_database -f database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql
```
...
- [ ] **Run database/ADD_MISSING_PROFILES_COLUMNS.sql** in production database
- [ ] **Verify columns added** (check output of verification queries)
- [ ] **Run database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql** in production database
...
- [database/ADD_MISSING_PROFILES_COLUMNS.sql](database/ADD_MISSING_PROFILES_COLUMNS.sql) ✅ **CREATED** - SQL migration to add columns
- [database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql](database/CREATE_SUBSCRIPTION_SYNC_TRIGGER.sql) ✅ **CREATED** - SQL migration for sync trigger
