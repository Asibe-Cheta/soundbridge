          ...
          <div className="navbar-main" style={{ 
            ...
            <div className="navbar-left" style={{ 
              ...
              <nav className="nav" style={{ display: 'flex', gap: '0.5rem' }}>
                ...
                <Link href="/discover" className="active" style={{ 
                  textDecoration: 'none', 
            ...
            {user ? (
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <div>
                    <div style={{ color: 'white', fontWeight: '600' }}>Welcome back!</div>
                    <div style={{ color: '#999', fontSize: '14px' }}>Manage your account</div>
                  </div>
                </div>
                
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <Link href="/profile" onClick={() => setIsMobileMenuOpen(false)} style={{ textDecoration: 'none', flex: 1 }}>
                    <button style={{
                      width: '100%',
                      padding: '12px',
                      background: 'rgba(255, 255, 255, 0.1)',
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <Link href="/login" onClick={() => setIsMobileMenuOpen(false)} style={{ textDecoration: 'none', flex: 1 }}>
                  <button style={{
                    width: '100%',
                    padding: '16px',
                    background: 'rgba(255, 255, 255, 0.1)',
                ...
                <Link href="/signup" onClick={() => setIsMobileMenuOpen(false)} style={{ textDecoration: 'none', flex: 1 }}>
                  <button style={{
                    width: '100%',
                    padding: '16px',
                    background: 'linear-gradient(45deg, #DC2626, #EC4899)',
