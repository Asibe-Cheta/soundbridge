...
const FOUNDER_BIO_PARAGRAPHS = [
  'SoundBridge was not built in a boardroom. It was built out of frustration, conviction, and a £6 royalty statement.',
  ...
  'I sat with that frustration for a long time — reflecting on what creators actually need and what I could build with the skills I had: engineering, music, and lived experience on both sides of the platform.',
  'The idea for SoundBridge came from that clarity: the problem I had lived through is one that millions of creators around the world are living through right now.',
  'So I built what I wished had existed. A professional home for audio creators. A place where your talent speaks louder than your follower count. Where you keep 85-90% of everything you earn. Where your fans can find you, not because you paid for an ad, but because they already care about your genre, your sound, your world. Where events reach the people who actually want to be in the room.',
  ...
  'My name is Justice Asibe. I am a signed recording artist, a software engineer, an MBA graduate, and the founder of SoundBridge. I built this for every creator who has ever felt invisible — gospel, secular, and every genre in between.',
];
