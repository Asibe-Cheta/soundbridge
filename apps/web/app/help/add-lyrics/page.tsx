      ...
      <main className="main-container py-8 lg:py-12">
        <nav className="mb-8" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Adding Lyrics to Tracks</li>
          </ol>
        </nav>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <h1 className={`text-4xl lg:text-5xl font-bold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
              Adding Lyrics to Tracks
            </h1>
            <p className={`text-lg lg:text-xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
              Help listeners connect with your music by adding lyrics
            </p>
          </div>

          <div className="space-y-8">
            <section>
              <h2 className={`text-2xl font-bold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Why Add Lyrics?</h2>
              <p className={`text-lg leading-relaxed mb-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                Adding lyrics to your tracks helps listeners understand and connect with your music. Many people search for songs by their lyrics, so adding them can help more people discover your music.
              </p>
            </section>

            <section>
              <h2 className={`text-2xl font-bold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>How to Add Lyrics</h2>
              <ol className={`space-y-3 mb-6 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                <li className="flex gap-4">
                  ...
                  <div>When uploading or editing a track, find the "Lyrics" section</div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>Type or paste your lyrics into the text box</div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>Select the language of your lyrics from the dropdown menu</div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>Click "Save" to add the lyrics to your track</div>
                </li>
              </ol>
            </section>

            <section>
              <h2 className={`text-2xl font-bold mb-4 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Tips for Formatting Lyrics</h2>
              <div className={`p-6 rounded-lg border ${theme === 'dark' ? 'bg-blue-500/10 border-blue-500/20' : 'bg-blue-50 border-blue-200'}`}>
                <ul className={`space-y-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>
                  <li className="flex items-start gap-3">
                    ...
                    <span>Use line breaks to separate verses and choruses</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className={`w-5 h-5 mt-1 flex-shrink-0 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`} />
                    <span>Add [Chorus] or [Verse] labels if helpful</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className={`w-5 h-5 mt-1 flex-shrink-0 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`} />
                    <span>Make sure lyrics match what's actually sung</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className={`w-5 h-5 mt-1 flex-shrink-0 ${theme === 'dark' ? 'text-green-400' : 'text-green-600'}`} />
                    <span>You can edit lyrics anytime by editing the track</span>
                  </li>
                </ul>
              </div>
            </section>
