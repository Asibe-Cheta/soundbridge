        ...
        <div className="container mx-auto px-4 py-6 lg:py-8">
          ...
          <div className="mb-8 lg:mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              <div
                className={`group relative p-6 rounded-xl transition-all border overflow-hidden ${
                  theme === 'dark'
    ...
    >
      <StructuredData
        ...
        data={{
          ...
          description:
            'Professional networking platform for audio creators. Connect with musicians, podcasters, and producers. Promote events for free and keep 90% of your revenue.',
          offers: {
            '@type': 'Offer',
            price: '0',
            priceCurrency: 'GBP'
      ...
      <div className="container mx-auto px-4 py-10 lg:py-16">
        ...
        <section className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className={`text-lg lg:text-xl mb-8 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                Promote events to qualified local audiences for free. No more £200 Facebook ads for empty venues.
              </p>
            </div>
            <div
              className={`rounded-2xl p-6 border ${
            ...
            >
              ...
              <h3 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                Connect Based on Talent
              </h3>
              <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                Find collaborators, producers, and opportunities through quality-based discovery. Not followers.
              </p>
            </div>
            <div
              className={`rounded-2xl p-6 border ${
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className={`text-lg ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
              Most audio creators juggle 7+ tools: SoundCloud for hosting, Instagram for promotion, Fiverr for
              services, Eventbrite for events, LinkedIn for networking. It&apos;s exhausting. SoundBridge
              consolidates everything in one professional platform.
            </p>
          </div>
        </section>
        ...
        <section className="mt-12 lg:mt-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            <div
              className={`relative rounded-2xl p-8 lg:p-10 overflow-hidden border ${
                theme === 'dark'
        ...
        <section
          className={`mt-12 lg:mt-16 rounded-2xl overflow-hidden relative ${
        ...
        <section
          className={`mt-12 lg:mt-16 text-center p-8 lg:p-12 rounded-2xl ${
            theme === 'dark'
