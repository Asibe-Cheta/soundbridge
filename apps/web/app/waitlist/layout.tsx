...
export const metadata: Metadata = {
  ...
  description: 'Be among the first artists to join SoundBridge. Earn 85% from tips (15% platform fee), connect with industry professionals, and build your music career. UK-based platform launching 2026.',
  ...
  twitter: {
    ...
    description: 'Earn 85% from tips. Network like LinkedIn for music.',
