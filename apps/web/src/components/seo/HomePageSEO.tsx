...
export function HomePageSEO() {
  ...
  return (
    <>
      ...
      {/* Google Analytics - Only load if GA ID is configured */}
      {process.env.NEXT_PUBLIC_GA_ID && process.env.NEXT_PUBLIC_GA_ID !== 'disabled' && (
        <>
          <Script
            id="google-analytics"
      ...
      {process.env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID && process.env.NEXT_PUBLIC_FACEBOOK_PIXEL_ID !== 'disabled' && (
        <Script
          id="facebook-pixel"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
      ...
      {/* Twitter Pixel - Only load if Pixel ID is configured */}
      {process.env.NEXT_PUBLIC_TWITTER_PIXEL_ID && process.env.NEXT_PUBLIC_TWITTER_PIXEL_ID !== 'disabled' && (
        <Script
          id="twitter-pixel"
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
