    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700 p-4">
        <p className="text-gray-300 text-sm mb-3">
          Your digital wallet stores earnings from gigs, tips, and content sales. Once funds are in your wallet, you can request a withdrawal to your local bank account at any time (minimum $20).
        </p>
