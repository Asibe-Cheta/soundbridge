...
export function normalizeBrandingRpcResult(data: unknown, userId: string): CustomBranding | null {
  ...
  let background_gradient: string;
  ...
  return {
    ...
    primary_color: (o.primary_color as string) ?? DEFAULT_BRANDING.primary_color,
    secondary_color: (o.secondary_color as string) ?? DEFAULT_BRANDING.secondary_color,
    accent_color: (o.accent_color as string) ?? DEFAULT_BRANDING.accent_color,
    background_gradient,
    layout_style:
      (o.layout_style as CustomBranding['layout_style']) ?? DEFAULT_BRANDING.layout_style,
    show_powered_by: (o.show_powered_by as boolean) ?? DEFAULT_BRANDING.show_powered_by,
