-- ============================================================================
-- Fix RPC Functions - Simple Approach (No Dynamic SQL)
-- Date: December 3, 2025
-- Purpose: Recreate RPC functions with the simplest possible approach
--          to avoid any column resolution issues
-- ============================================================================
...
-- ============================================================================
-- UPDATE Function - SIMPLEST VERSION
-- ============================================================================
...
AS $$
BEGIN
  -- Simple UPDATE with explicit table qualification
...
-- ============================================================================
-- INSERT Function - SIMPLEST VERSION
-- ============================================================================
...
DECLARE
  new_id UUID;
BEGIN
  -- Simple INSERT with explicit table qualification
