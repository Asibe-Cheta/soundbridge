-- Insert a Conference test event for 20 Feb 2026 (same location & title)
-- Run this in Supabase SQL Editor to trigger event notifications.
...
INSERT INTO events (
  ...
  'SoundBridge app launch – 20 Feb 2026. Use this to test push and in-app notifications.',
