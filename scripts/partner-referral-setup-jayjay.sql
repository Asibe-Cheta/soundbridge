-- =============================================================================
-- Partner referral setup — anthonydover18@gmail.com / @jayjay (prod: aunxdbqukbxyyiusaeqi)
-- =============================================================================
-- What this script does (same bundle as dannymoffat / saliclintonreal / melvinwonder):
--   1. Ensures profiles.role = 'creator' (already true for this account — no-op)
...
--   4-creator batch / dannymoffat09 / saliclintonreal / melvinwonder — 1 year Premium, 10% commission
...
WHERE lower(u.email) = lower('anthonydover18@gmail.com');
...
-- -----------------------------------------------------------------------------
-- 2) APPLY — set role = creator (already 'creator' on this account — no-op safeguard)
-- -----------------------------------------------------------------------------
/*
...
FROM auth.users u
WHERE p.id = u.id
  AND lower(u.email) = lower('anthonydover18@gmail.com')
