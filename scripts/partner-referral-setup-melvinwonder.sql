-- =============================================================================
-- Partner referral setup — melvinwonder@gmail.com (prod: aunxdbqukbxyyiusaeqi)
-- =============================================================================
-- What this script does (same bundle as dannymoffat / saliclintonreal / 4-creator batch):
...
--   4-creator batch / dannymoffat09 / saliclintonreal — 1 year Premium, 10% commission
...
WHERE lower(u.email) = lower('melvinwonder@gmail.com');
...
FROM auth.users u
WHERE p.id = u.id
  AND lower(u.email) = lower('melvinwonder@gmail.com')
