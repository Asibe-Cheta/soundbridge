-- Fix: "Returned type character varying(50) does not match expected type text in column 3"
-- profiles.username (and similar) are VARCHAR; function declares TEXT. Cast to TEXT so RPC result matches.
