-- Demand-led event creation (poll campaigns, threshold notifications, live interest push tracking)
-- Requires 20260531115900_demand_led_events_message_type_enum.sql committed first (Postgres 55P04).
