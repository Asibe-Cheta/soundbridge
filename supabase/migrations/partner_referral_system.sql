...
drop policy if exists "Partners can read own referral signups" on public.referral_signups;
...
drop policy if exists "Users can read own institutional access" on public.institutional_access;
